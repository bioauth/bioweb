...
app.post('/user/update', passport.authenticate('accessToken'), require('./handlers/user/update').update);
...
app.post('/external/verify', passport.authenticate('accessToken'), require('./handlers/external').verify);
